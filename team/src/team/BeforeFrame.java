...
// ImageTextPair[i]
				new ImageTextPair("images/ball_1.png", "1"), new ImageTextPair("images/ball_2.png", "2"),
				new ImageTextPair("images/basicCircle.png", "3"), new ImageTextPair("images/basicCircle.png", "4"),
				new ImageTextPair("images/basicCircle.png", "5"), new ImageTextPair("images/basicCircle.png", "6"),
				new ImageTextPair("", "+"), new ImageTextPair("images/basicCircle.png", "7"),
		...
		JLabel lblNewLabel = new JLabel("당첨 회차");
